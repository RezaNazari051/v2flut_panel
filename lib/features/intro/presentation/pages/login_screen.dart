                          ...
                          onPressed: () {
                            if (usernameController.text.isNotEmpty &&
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                const SnackBar(
                                  content: Text(
                                      'لطفا مقادیر ورودی را برسی کنید'),
        ...
        BlocConsumer<LoginBloc, LoginState>(
          listener: (context, state) {
            if(state.loginStatus is LoginUserError){
              final LoginUserError loginUserError=state.loginStatus as LoginUserError;
              ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text(loginUserError.errorMessage),backgroundColor: Colors.red,));
            }
            if(state.loginStatus is LoginUserCompleted){
              ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('ورود موفقیت آمیزبود'),backgroundColor: Colors.green));

              Future.delayed(const Duration(seconds: 2),(){
                Navigator.push(context, CupertinoPageRoute(builder: (context) => const MainWrapper(),));
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: OutlinedButton(
                                ...
                                onPressed: state.loginStatus is LoginUserLoading?null:() {
